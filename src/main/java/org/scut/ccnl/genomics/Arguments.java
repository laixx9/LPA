...
//    public static String FASTA_PREFIX ="/SHARE/wzz_workstation/index/hg19";
    public static String FASTA_INDEX = FASTA_PREFIX + ".fa.fai";
    public static String FASTA_DICT = FASTA_PREFIX + ".dict";
    public static String FASTA = FASTA_PREFIX + ".fa";
    public static String MODEL_PATH;
    public static String CONTIG_MAPPING;
    public static String RG_MAPPING;
    public static int SHARD_SIZE = 10000;
    //public static int SUBLIST_OVERLAP_SIZE = 500;
    public static int SUBLIST_OVERLAP_SIZE = 0;
//    public static int INPUT_FORMAT_OVERLAP_SIZE = 0;
    ...
    // 每个分块切分多个
    public static volatile int ADDITION_EACH_SPLIT_SIZE = 1;
    ...
    public static volatile List<Integer> PARTITIONS_TO_CHANGE;
    ...
    public static void init() {
        ...
        if (FROM_LOCAL) {
            ...
            FASTA_INDEX = FASTA_PREFIX + ".fa.fai";
            FASTA_DICT = FASTA_PREFIX + ".dict";
            FASTA = FASTA_PREFIX + ".fa";
        }
    }
