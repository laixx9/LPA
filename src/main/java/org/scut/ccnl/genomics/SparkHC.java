...
public class SparkHC {
    ...
    public static void main(String[] args) throws Exception {
        ...
        options.addOption("m", "model-path", true, "model-path");
        options.addOption("cm", "contig-mapping-path", true, "contig-mapping-path");
        options.addOption("rm", "reference-genome-mapping-path", true, "reference-genome-mapping-path");
